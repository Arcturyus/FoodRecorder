...
/**
 * Onglet « Profil » : tout ce qui vous concerne, vous. Le profil (corps, activité
 * quotidienne, sport, objectif) qui pilote les cibles, la dépense énergétique qui
 * en découle, la connexion au compte de synchro, puis les pesées qui alimentent le
 * poids — dictée/analyse d'une pesée → pré-remplissage du formulaire →
 * enregistrement, courbe et historique éditable.
 */
